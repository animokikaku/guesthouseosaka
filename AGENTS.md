...
2) Apply those rules as you code—keep Studio files aligned with deployed schema.  
3) After schema edits: deploy (`bunx sanity schema deploy`), run TypeGen, and then proceed with content operations.
