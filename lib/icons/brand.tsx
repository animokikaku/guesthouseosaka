 ...
 * 5.2 MB barrel with no per-icon entry point, so importing two glyphs from it
 * made every build parse all 3,400 — for two static path strings. Refresh from
...
const FacebookIcon = createBrandIcon(
  'Facebook',
