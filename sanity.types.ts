...
// Query: *[_type == "house"] | order(orderRank){  _id,  _type,  slug,  "title": coalesce(title[_key == $locale][0].value, title[_key == "en"][0].value),  "building": building{    rooms,    floors  },  phone,  "extraCosts": array::compact(extraCosts[]{    "slug": category->slug.current,    "value": coalesce(value[_key == $locale][0].value, value[_key == "en"][0].value)[]  })}
