...
/** Keeps the menu anchored while scrolling; override via `positioner` when needed. */
const defaultPositionerProps: Partial<NavigationMenuPrimitive.Positioner.Props> = {
...
function NavigationMenu({
  ...
  positioner?: Partial<NavigationMenuPrimitive.Positioner.Props>
}) {
  return (
    ...
    >
      {children}
      <NavigationMenuPositioner {...defaultPositionerProps} {...positioner} />
    </NavigationMenuPrimitive.Root>
  )
}
...
function NavigationMenuIndicator({
  ...
  return (
    <NavigationMenuPrimitive.Icon
      ...
      className={cn(
        "top-full z-1 flex h-1.5 items-end justify-center overflow-hidden opacity-0 data-popup-open:animate-in data-popup-open:fade-in data-popup-open:opacity-100",
        className
      )}
      {...props}
    >
