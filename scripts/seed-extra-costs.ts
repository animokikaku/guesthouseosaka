...
const extraCostsData: Record<
  string,
  Array<{ category: string; en: string; ja: string; fr: string }>
> = {
  orange: [
  ...
  lemon: [
    ...
    {
      category: 'utility-fees',
      en: 'Summer/Winter: ¥3,000-¥7,000\nSpring/Autumn: ¥2,000-¥4,000',
      ja: '夏/冬: ¥3,000-¥7,000\n春/秋: ¥2,000-¥4,000',
      fr: 'Été/Hiver: ¥3,000-¥7,000\nPrintemps/Automne: ¥2,000-¥4,000'
    },
    { category: 'water-bill', en: 'Free', ja: '無料', fr: 'Gratuit' },
    { category: 'laundromat', en: 'Free', ja: '無料', fr: 'Gratuit' },
    {
  ...
  apple: [
    ...
    {
      category: 'laundromat',
      en: 'Each room has a private washing machine',
      ja: '各部屋に専用洗濯機付き',
      fr: "Chaque chambre dispose d'un lave-linge privé"
    },
...
async function seedExtraCosts() {
  ...
  for (const house of houses) {
    ...
    await client.patch(house._id).set({ extraCosts }).commit()
